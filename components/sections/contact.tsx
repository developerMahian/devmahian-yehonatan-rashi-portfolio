...
const ContactSection = () => {
	...
	return (
		...
		>
			...
			<Text color="darkBg.50" fontWeight={500} textAlign="center" mb={{ base: "50px", sm: "70px" }}>
				אחזור אליכם בהקדם האפשרי בדוא”ל. אם יש העדפה לוואצאפ, כתבו את הטלפון שלכם.
			</Text>
			...
			<Box as="form" onSubmit={formHandler}>
				<Flex
					...
					lineHeight="23.5px"
				>
					<Box flex={1} bgColor="darkBg.100" borderRadius="8px" p={{ base: "10px 18px", sm: "14px 25px" }}>

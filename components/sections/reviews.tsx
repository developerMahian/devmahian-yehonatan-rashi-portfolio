...
const reviewsData: ReviewsData[] = [
  ...
  },
  {
    ...
    caption: "200 אלף איש",
    review:
      "יהונתן מעצב מאוד רציני ומקצועי העומד באחריות שלו, קיבלת מטלות לעיצובים של קהילה בגודל 200 אלף איש וביצע אותם כמו שצריך על הצד הטוב ביותר.",
  },
  {
    id: 3,
    ...
    review:
      "התוצאה הייתה בדיוק מה שרציתי וגם יהונתן היה שירותי ומקצועי בטירוף, הקשבת לכל הרצונות שלי בסבלנות אין סופית	תודה על הכל ובטוחה שניפגש בהמשך🙏",
  },
];
    ...
    >
      ...
      >
        <Carousel controls={false} interval={2000}>
          {reviewsData?.map(
            ({ id, name, profile_pic, caption, review }: ReviewsData) => (
